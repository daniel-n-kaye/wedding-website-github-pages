 ...
 * limitations under the License.
 */
class vd{constructor(t,e){this._firestore=t,this._commitHandler=e,this._mutations=[],this._committed=!1,this._dataReader=Ch(t)}set(t,e,n){this._verifyNotCommitted();const r=wd(t,this._firestore),i=od(r.converter,e,n),s=kh(this._dataReader,"WriteBatch.set",r._key,i,null!==r.converter,n);return this._mutations.push(s.toMutation(r._key,ea.none())),this}update(t,e,n,...r){this._verifyNotCommitted();const i=wd(t,this._firestore);let s;return s="string"==typeof(e=(0,a.m9)(e))||e instanceof yh?Oh(this._dataReader,"WriteBatch.update",i._key,e,n,r):Rh(this._dataReader,"WriteBatch.update",i._key,e),this._mutations.push(s.toMutation(i._key,ea.exists(!0))),this}delete(t){this._verifyNotCommitted();const e=wd(t,this._firestore);return this._mutations=this._mutations.concat(new pa(e._key,ea.none())),this}commit(){return this._verifyNotCommitted(),this._committed=!0,this._mutations.length>0?this._commitHandler(this._mutations):Promise.resolve()}_verifyNotCommitted(){if(this._committed)throw new ui(ci.FAILED_PRECONDITION,"A write batch can no longer be used after commit() has been called.")}}function wd(t,e){if((t=(0,a.m9)(t)).firestore!==e)throw new ui(ci.INVALID_ARGUMENT,"Provided document reference is from a different Firestore instance.");return t}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
function _d(t){return ph(t=eh(t,dh)),new vd(t,(e=>md(t,e)))
/**
 * @license
 * Copyright 2021 Google LLC
 *
...
//# sourceMappingURL=chunk-vendors.16ed7384.js.map